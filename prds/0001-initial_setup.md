...
1. The following directories are checked into git with the specified placeholder/template files:
  - `prds/` — contains `0000-template.md` (PRD template) and this file
  - `plans/` — contains `0001-initial_setup.md` (the plan for this work; serves as the template example)
...
1. Base example/template files exist to give agents a framework to follow in the future:
  - `prds/0000-template.md` — blank PRD template with all standard sections
  - `plans/0001-initial_setup.md` — first real plan; doubles as the plans template example
...
| --- | --- | --- |
| Where should `0000-template.md` live — repo root or `prds/`? | `prds/` | 2026-03-13 |
